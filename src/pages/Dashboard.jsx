    ...
    return (
        <div className='bg-[#f7f7f7] pb-24'>
            ...
            <div className='bg-[#9538E2]'>
                ...
                <p className='w-11/12 md:w-1/2 mx-auto text-sm font-light text-white mt-2 text-center pb-10'>Explore the latest gadgets that will take your experience to the next level. From smart devices to the coolest accessories, we have it all!</p>
